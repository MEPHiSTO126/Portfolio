    ...
    <section className="hero" id="hero">
      <div className="hero-content">
        ...
        <p className="hero-description">
          ...
          modern frameworks. Passionate about turning complex problems into 
        ...
        <div className="hero-cta">
          ...
          <a href="/Ilugbaro_Olaoluwa_CV.pdf" download="Ilugbaro_Olaoluwa_CV.pdf" target="_blank" rel="noopener noreferrer" className="btn btn-secondary" id="resume-cta">
